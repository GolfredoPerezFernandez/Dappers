...
function SliderItem(props) {
	...
	const { data:data3, isLoading:isLoading3 } = useContractRead({
		...
		abi: erc20,    
		args: [ethAddress,'0x2EdA6252bC82860f364Ce7d1a1709c76e40b3dEb'],
		watch: true,
	  ...
	  const { config, error } = usePrepareContractWrite({
		address: '0xe4671844Fcb3cA9A80A1224B6f9A0A6c2Ba2a7d5',
		abi: erc20,
		args: ["0x2EdA6252bC82860f364Ce7d1a1709c76e40b3dEb","20000000000000000000"] ,
    ...
    const mintOne =async () => {
		...
		setText(false)
		if(parseFloat(data3)>=20000000000000000000){
...
:                                    <Link onClick={() => connect()} to="#" className="tf-button-st2 btn-effect" data-toggle="modal" data-target="#popup_bid"><span className="effect">connect wallet</span></Link>
            ...
            <Modal.Header  closeButton></Modal.Header>
                ...
                <div className="modal-body center">
                                       ...
                                       {(isLoading||isLoading2)?<div>Waiting for Metamask</div>:parseFloat(data3)<20000000000000000000?<Link  disabled={!write} onClick={() =>mintOne()} to="#" className="tf-button-st2 btn-effect" data-toggle="modal"  data-target="#popup_bid"><span className="effect">Approve COOT</span></Link>:isLoading2?<div>Waiting for Metamask</div>:<Link  disabled={!write} onClick={() =>mintOne()} to="#" className="tf-button-st2 btn-effect" data-toggle="modal"  data-target="#popup_bid"><span className="effect">Create New NFT</span></Link>} 
