...
export function  BtnMint() {
  ...
  return (
    <>
        { isLoading?<div>Loading</div>:<Link  disabled={!write} onClick={() =>mintOne()} to="#" className="tf-button-st2 btn-effect" data-toggle="modal"  data-target="#popup_bid"><span className="effect">Create New NFT</span></Link>} 
